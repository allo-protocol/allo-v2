...
```solidity
function addAllocator(address _allocator) external nonpayable
```
...
| Name | Type | Description |
|---|---|---|
| _allocator | address | The allocator address |
...
```solidity
function removeAllocator(address _allocator) external nonpayable
```
