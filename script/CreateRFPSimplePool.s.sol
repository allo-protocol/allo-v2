...
contract CreateRFPSimplePool is Script, Native, Config {
    ...
    function run() external {
        ...
        allo.createPool{value: 1e16}(TEST_PROFILE_1, RFPSIMPLESTRATEGY, initParams, NATIVE, 1e16, metadata, managers);
