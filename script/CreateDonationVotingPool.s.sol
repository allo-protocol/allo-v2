...
///      'forge script script/CreateDonationVotingPool.s.sol:CreateDonationVotingPool --rpc-url $GOERLI_RPC_URL --broadcast  -vvvv'
contract CreateDonationVotingPool is Script, Native, GoerliConfig {
    ...
    function run() external {
        ...
        allo.createPool{value: 1e16}(
            TEST_PROFILE_2,
            address(DONATIONVOTINGMERKLEPAYOUTSTRATEGYFORCLONE),
            encodedStrategyData,
            NATIVE,
            1e16,
            metadata,
